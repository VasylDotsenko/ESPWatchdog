...
Проєкт ще не є фінальним production-релізом. Поточний стан позначено як `v0.4.24-network-status-snapshot`.
...
1. Зафіксувати `v0.4.24-network-status-snapshot` як hardware-verified baseline.
