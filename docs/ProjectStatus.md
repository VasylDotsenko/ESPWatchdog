...
Проєкт ще не є фінальним production-релізом. Поточний стан позначено як `v0.4.23-system-status-snapshot`.
...
1. Зафіксувати `v0.4.23-system-status-snapshot` як hardware-verified baseline.
